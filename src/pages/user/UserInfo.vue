<template>
  ...
  <div v-if="!isLoading && !!!error">
    ...
    <div
      ...
      v-if="
        userFromStore.country !== null &&
        userFromStore.street !== null &&
        userFromStore.city !== null
      "
    >
      <div class="profile-info-row">
    ...
    <div class="buttons">
      <base-button>
        <router-link class="link" to="/user/me/changeDetails"
          >Zmień dane</router-link
        >
      </base-button>
      <base-button mode="type2">
        <router-link class="link2" to="/user/me/changePassword"

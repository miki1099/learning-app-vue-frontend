  ...
  components: { BaseDialog },
    ...
    methods: {
        async submitMethod() {
            ...
            const response = await fetch('https://learning-app-stars.herokuapp.com/admin/question/create', {
                method: 'POST',
                headers: headers,
                body: JSON.stringify({
            ...
            if(!response.ok) {
                if(response.status == 401) {
                    ...
                    this.error = 'Nie udało się stworzyć pytania. Spróbuj ponownie później';
                }
                this.isLoading = false;
                return
            } else {
